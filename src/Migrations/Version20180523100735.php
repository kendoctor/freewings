 ...
 */
class Version20180523100735 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307FBF396750 FOREIGN KEY (id) REFERENCES post (id) ON DELETE CASCADE');
    }
